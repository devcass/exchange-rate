...
<p align="center">:moneybag: Select countries to get the exchange rate for a specific amount</p>
...
1. Clone the project with `git@github.com:devcass/exchange-rate.git`
2. Enter in the project with `cd exchange-rate`
